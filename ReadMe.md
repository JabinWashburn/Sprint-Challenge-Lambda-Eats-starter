...
it lets your use Route wihtout having to wrap everything in <Route> tags. but otherwise acts the same

2. How would you explain form validation to someone who has never programmed before?

form validation is just making sure that fields of a form are filled out properly to the forms requirements.

3. In 1-2 sentences, define end to end testing.

end to end testing is making sure every little part of a page is working as expected. links, forms etc all doing wha they are supposed to. 
